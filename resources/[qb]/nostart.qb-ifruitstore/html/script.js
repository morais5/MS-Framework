...
$(document).ready(function() {
    ...
    window.addEventListener('click',function() {
        ...
        if (distance < HitDistance) {
            ...
            MainDigits--;
            $.post("http://qb-ifruitstore/thermiteclick");
...
Thermite.Failed = function() {
    if (active) $.post("http://qb-ifruitstore/thermitefailed");
    active = false;
    Thermite.Close();
}

Thermite.Success = function() {
    if (active) $.post("http://qb-ifruitstore/thermitesuccess");
    active = false;
    Thermite.Close();
}
...
Thermite.Close = function() {
    ...
    $.post('http://qb-ifruitstore/closethermite');
}