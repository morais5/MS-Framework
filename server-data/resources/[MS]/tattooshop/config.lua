Config = {}
----------sets all the proper locations of the tattoos to be seen change the vc points to increase or decrease range----------
...
Config.TattooCats = {
	...
	{"ZONE_LEFT_ARM", "Left Arm", {vec(-0.6, 0.7, 0.4), vec(-0.9, 0.2, 0.4), vec(-0.4, -0.5, 0.2)}, vec(-0.2, 0.0, 0.2)},
	{"ZONE_RIGHT_ARM", "Right Arm", {vec(0.6, 0.7, 0.4), vec(0.9, 0.2, 0.4), vec(0.4, -0.5, 0.2)}, vec(0.2, 0.0, 0.2)},
...
------------Shops Shops Shops Shops EVERYBODY
Config.Shops = {
	...
	vec(-1055.08, -2742.82, 14.61)
}
---------grabs all the interiors----------
Config.interiorIds = {}
