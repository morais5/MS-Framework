...
AddEventHandler('Apply:Tattoo', function(tats) 
	...
	MSCore.Functions.TriggerCallback('SmallTattoos:GetPlayerTattoos', function(tattooList)
		if tattooList then
...
------------------If you are running the base msus you should still have the ability for skinchanger i myself do not use it so i make my players do it manually with the altered dpclothing --------------
function GetNaked()
...
function BuyTattoo(collection, name, label, price)
	MSCore.Functions.TriggerCallback('SmallTattoos:PurchaseTattoo', function(success)
		if success then
