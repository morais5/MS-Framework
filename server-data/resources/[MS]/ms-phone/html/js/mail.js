...
$(document).on('click', '.mail', function(e){
    ...
    ms.Phone.Functions.SetupMail(MailData);
...
ms.Phone.Functions.SetupMails = function(Mails) {
    ...
    $("#mail-header-mail").html(ms.Phone.Data.PlayerData.charinfo.firstname+"."+ms.Phone.Data.PlayerData.charinfo.lastname+"@mail.ls");
...
ms.Phone.Functions.SetupMail = function(MailData) {
...
$(document).on('click', '#new-advert-submit', function(e){
    ...
    if (Advert !== "") {
        ...
        ms.Phone.Notifications.Add("fas fa-ad", "Advertisement", "Can not make an empty ad!", "#ff8f1a", 2000);
    }
});

ms.Phone.Functions.RefreshAdverts = function(Adverts) {
    $("#advert-header-name").html("@"+ms.Phone.Data.PlayerData.charinfo.firstname+""+ms.Phone.Data.PlayerData.charinfo.lastname+" | "+ms.Phone.Data.PlayerData.charinfo.phone);
