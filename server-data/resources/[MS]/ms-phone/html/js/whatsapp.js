...
ms.Phone.Functions.GetLastMessage = function(messages) {
...
ms.Phone.Functions.LoadWhatsappChats = function(chats) {
    $(".whatsapp-chats").html("");
    $.each(chats, function(i, chat){
        ...
        var LastMessage = ms.Phone.Functions.GetLastMessage(chat.messages);
...
ms.Phone.Functions.ReloadWhatsappAlerts = function(chats) {
    $.each(chats, function(i, chat){
        if (chat.Unread > 0 && chat.Unread !== undefined && chat.Unread !== null) {
            $(".unread-chat-id-"+i).html(chat.Unread);
            $(".unread-chat-id-"+i).css({"display":"block"});
...
$(document).on('click', '#whatsapp-openedchat-send', function(e){
    ...
    if (Message !== null && Message !== undefined && Message !== "") {
        ...
        ms.Phone.Notifications.Add("fab fa-whatsapp", "Whatsapp", "You cannot send empty messages!", "#25D366", 1750);
    }
});
...
// ms.Phone.Functions.SetupChatMessages = function(cData, NewChatData) {
//     if (cData) {
...
//                 var Sender = "me";
//                 if (message.sender !== ms.Phone.Data.PlayerData.citizenid) { Sender = "other"; }
//                 var MessageElement
