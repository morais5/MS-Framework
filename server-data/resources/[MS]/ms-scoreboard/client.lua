...
AddEventHandler('MSCore:Client:OnPlayerLoaded', function()
    ...
    MSCore.Functions.TriggerCallback('ms-scoreboard:server:GetConfig', function(config)
    ...
    while true do
        if IsControlJustPressed(0, Config.OpenKey) then
            if not scoreboardOpen then
                MSCore.Functions.TriggerCallback('ms-scoreboard:server:GetPlayersArrays', function(playerList)
                    MSCore.Functions.TriggerCallback('ms-scoreboard:server:GetActivity', function(cops, ambulance)
...
RegisterNetEvent('ms-scoreboard:client:SetActivityBusy')
AddEventHandler('ms-scoreboard:client:SetActivityBusy', function(activity, busy)
