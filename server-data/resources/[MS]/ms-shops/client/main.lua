...
RegisterNetEvent('ms-shops:client:UpdateShop')
AddEventHandler('ms-shops:client:UpdateShop', function(shop, itemData, amount)
    TriggerServerEvent('ms-shops:server:UpdateShopItems', shop, itemData, amount)
end)

RegisterNetEvent('ms-shops:client:SetShopItems')
AddEventHandler('ms-shops:client:SetShopItems', function(shop, shopProducts)
    Config.Locations[shop]["products"] = shopProducts
end)

RegisterNetEvent('ms-shops:client:RestockShopItems')
AddEventHandler('ms-shops:client:RestockShopItems', function(shop, amount)
