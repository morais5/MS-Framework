...
Citizen.CreateThread(function()
	...
	while MSCore.Functions.GetPlayerData().job == nil do
		Citizen.Wait(10)
	end
              ...
              ----se sono in macchina non esegue nessuna funzione
				...
				---------controllo se ho i punti xp---------------------------------------------------
                         ...
                         --controllo se ho l'item
                                        MSCore.Functions.TriggerCallback('MSCore:HasItem', function(result2)
                                        hasBagd7 = result2
                                        s1d7 = true
                                        end, 'black_money')
                                        while(not s1d7) do
                                        Citizen.Wait(100)
                                                  ...
                                                  ----se ho l'item eseguo
                                                    if (hasBagd7) then
                                                      ...
                                                      MSCore.Functions.Notify('You do not have dirty money', 'error')
                                                    end
...
function procOn()
    ...
    local inventory = MSCore.Functions.GetPlayerData().inventory
    local count = 0
    ----
    if(count == 0) then
    MSCore.Functions.Progressbar("search_register", "Cleaning..", 20000, false, true, {disableMovement = true,
