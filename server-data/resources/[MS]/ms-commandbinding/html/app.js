...
$(document).on('click', '.save-bindings', function(e){
    ...
    $.post('http://ms-commandbinding/save', JSON.stringify({
        keyData: keyData
    }));
});

msinding.Open = function(data) {
...
msinding.Close = function() {
    $(".container").fadeOut(150);
    $.post('http://ms-commandbinding/close');
}