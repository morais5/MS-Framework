    ...
    if (CurrentHouseData.keyholders !== undefined && CurrentHouseData.keyholders !== null) {
        $.each(CurrentHouseData.keyholders, function(i, keyholder){
            if (keyholder !== null && keyholder !== undefined) {
                var elem;
                if (keyholder.charinfo.firstname !== ms.Phone.Data.PlayerData.charinfo.firstname && keyholder.charinfo.lastname !== ms.Phone.Data.PlayerData.charinfo.lastname) {
...
$(document).on('click', '#myhouse-option-transfer-confirm', function(e){
    ...
    $.post('http://ms-phone_new/TransferCid', JSON.stringify({
        ...
        if (CanTransfer) {
            ...
            ms.Phone.Notifications.Add("fas fa-home", "Houses", "This ID is invalid", "#27ae60", 2500);
