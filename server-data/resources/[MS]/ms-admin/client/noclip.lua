...
RegisterNetEvent('ms-admin:client:toggleNoclip')
AddEventHandler('ms-admin:client:toggleNoclip', function()
    toggleNoClipMode()
end)
...
Citizen.CreateThread( function()
    ...
    function handleMovement(xVect,yVect)
        if ( IsControlJustPressed( 1, changeSpeedKey ) or IsDisabledControlJustPressed( 1, changeSpeedKey ) ) then
            ...
            MSCore.Functions.Notify("Current speed: ".. speeds[travelSpeed])
