RegisterServerEvent('MSCore:DebugSomething')
AddEventHandler('MSCore:DebugSomething', function(resource, obj, depth)
...
MSCore.Debug = function(resource, obj, depth)
    TriggerEvent('MSCore:DebugSomething', resource, obj, depth)
end

MSCore.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

MSCore.ShowSuccess = function(resource, msg)
