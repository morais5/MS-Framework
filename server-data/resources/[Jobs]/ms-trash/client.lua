...
Citizen.CreateThread(function()
    while MS == nil do
        TriggerEvent('MS:getSharedObject', function(obj) MS = obj end)
        Citizen.Wait(0)
    end
end)
                    ...
                    if IsControlJustReleased(0, 54) then
                        for i = 1, #searched do
                            ...
                            if i == #searched and dumpsterFound then
                                MSCore.Functions.Notify('This waste bin has already been searched', 'error')
                            elseif i == #searched and not dumpsterFound then
                                MSCore.Functions.Notify('You start to search the Trash Can')
...
function startSearching(time, dict, anim, cb)
 ...
 --   MSCore.Functions.Progressbar("reful_boat", "Searching The dumpster..", 14000)
