mumbleConfig = {
    voiceModes = {
        ...
        {7, "Normal"}, -- Normal speech distance in gta distance units
        {9, "Shouting"}, -- Shout speech distance in gta distance units
    },
    speakerRange = 1.4, -- Speaker distance in gta distance units (how close you need to be to another player to hear other players on the radio or phone)
