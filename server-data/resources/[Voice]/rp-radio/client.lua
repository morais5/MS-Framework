...
Radio.Commands = {
    {
        ...
        Help = "Portofoon", -- Command help shown in chatbox when typing the command
        Params = {},
...
exports("RadioAdd",RadioAdd)
exports("RadioRemove",RadioRemove)
