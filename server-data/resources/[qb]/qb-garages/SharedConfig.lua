Garages = {
  ...
  ["garagemcentral"] = {
    ...
    takeVehicle = {x = 215.54, y = -810.16, z = 30.73},
    spawnPoint = {x = 229.92, y = -798.01, z = 30.58, h = 161.37},
    putVehicle = {x = 214.71, y = -791.42, z = 30.84},
},
  ["spanishave"] = {
...
Depots = {
  ...
  ["hayesdepot2"] = {
    label = "Hayes Impound",
    takeVehicle = {x = 402.38, y = -1631.67, z = 29.29, h = 138.36}
  },
  ["hayesdepot3"] = {
    label = "Hayes Impound",
    takeVehicle = {x = 1875.62, y = 3686.86, z = 33.51, h = 244.58}
  },
  ["hayesdepot4"] = {
    label = "Hayes Impound",
    takeVehicle = {x = -474.65, y = 6025.85, z = 31.34, h = 312.64}
  }
}